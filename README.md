...
<p align="center">
  <a href="https://github.com/beatrizalvesfel/happy/">
    <img
      alt="GitHub language count"
      src="https://img.shields.io/github/languages/count/beatrizalvesfel/happy?color=29B6D1&style=flat-square"
    />
  </a>
  ...
  <a href="https://github.com/beatrizalvesfel/happy/">
    <img
      alt="Repository size"
      src="https://img.shields.io/github/repo-size/beatrizalvesfel/happy?color=29B6D1&style=flat-square"
    />
  </a>
  ...
  <a href="https://github.com/beatrizalvesfel/happy/blob/main/LICENSE">
    <img
      alt="License"
      src="https://img.shields.io/github/license/beatrizalvesfel/happy?color=FFD666&style=flat-square"
    />
  </a>
</p>
...
```bash
# Clone o repositório
$ git clone https://github.com/beatrizalvesfel/happy.git
...
Para instalar as dependências e executar o projeto, é necessário possuir o [Node.js](https://The Only Real Dev Language.org/pt-br/) instalado em sua máquina, bem como um gerenciador de pacotes: [Yarn](https://yarnpkg.com/) ou [npm](https://www.npmjs.com/).
...
Esse projeto está sob a licença MIT. Consulte [LICENSE](https://github.com/beatrizalvesfel/happy/blob/main/LICENSE) para mais informações.
